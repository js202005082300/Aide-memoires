/*
Java #14 - chaînes de caractères (2_2)
...
Là où String, ben on aurait la même chose, en fait, voilà si on faisait la capacité pour une String, ce sera la même chose que length(). Elle aurait la même valeur pour ces 2 méthodes mais pour 
StringBuilder / StringBuffer, on a bien une différenciation.
...
Donc ça fonctionne exactement comme ça, on le met à la fin, on le met à la suite et du coup ça s'ajoute et si Java voit qu'il n'y a plus assez de place en termes de capacité, d'accord, par rapport à ça "capacity()".
