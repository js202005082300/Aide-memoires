...
On retrouve 'SHA' ou son alias 'SHA1' et on
retrouve les autres et eux s'écrivent comme ceci 'SHA2_' underscore puisque évidemment il faut faire un peu plus compliqué et là vous mettez bien évidemment la taille en bits par rapport à l'algorithme utilisé, le 256 s'écrira de cette manière.
