...
Or pourquoi c'est un i pour représenter les minutes passent que le m est déjà réservé pour les mois. Le M majuscules minuscules c'est pour les mois donc comme on avait la même lettre, ils ont choisi le i et pour les secondes on va avoir le %S parce qu'on manipule les secondes complète donc de
0 à 59 secondes.
